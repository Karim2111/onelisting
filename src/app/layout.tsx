...
export const metadata: Metadata = {
  ...
  appleWebApp: { // https://nextjs.org/docs/app/api-reference/functions/generate-metadata#applewebapp
    ...
    startupImage: [
      ...
      {
        // This is the object corresponding to the initial string element
...
export default async function RootLayout({
  ...
  return (
    <ClerkProvider>
      <html lang="en" className={`${theme} ${GeistSans.className} ${GeistMono.variable}`} suppressHydrationWarning>
        <head>
